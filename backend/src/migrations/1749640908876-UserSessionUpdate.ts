...
export class UserSessionUpdate1749640908876 implements MigrationInterface {
  name = 'UserSessionUpdate1749640908876';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP COLUMN "token_type"`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP COLUMN "expires_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP COLUMN "revoked_at"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "userId" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "revokedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "rate_limits" ADD "ipAddress" inet NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "rate_limits" ADD "windowStart" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_894ba4f1802ad99c5ba771c1e8" ON "rate_limits" ("ipAddress", "endpoint") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD CONSTRAINT "FK_16804c993bc61c3849aabcb982a" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP CONSTRAINT "FK_16804c993bc61c3849aabcb982a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_sessions" DROP CONSTRAINT "FK_e9658e959c490b0a634dfc54783"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_894ba4f1802ad99c5ba771c1e8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rate_limits" DROP COLUMN "windowStart"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rate_limits" DROP COLUMN "ipAddress"`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP COLUMN "expiresAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP COLUMN "revokedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" DROP COLUMN "userId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "rate_limits" ADD "ip_address" inet NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "revoked_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "token_type" character varying(20) DEFAULT 'access'`,
    );
    await queryRunner.query(
      `ALTER TABLE "revoked_tokens" ADD "user_id" uuid NOT NULL`,
    );
    await queryRunner.query(
